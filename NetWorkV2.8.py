...
def forward_and_backprop(in_vector, in_W, in_N, hid_W, hidden_layers_count, neur_in_hid_l_count, out_W, neurons_out_l,
    ...
    in_vector=in_vector.reshape((inNeur,1))
    in_vector=in_vector.T
    ...
    update_weights(in_W, in_vector, hid_W, H_hid, out_W, H_out,error,neruons_out_l)
...
def update_weights(in_W, in_H, hid_W, hid_H, out_W, out_H, E, neruons_out_l):
