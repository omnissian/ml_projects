...
def parser(labels, path='D:\\Polygon\\Examples\\plgn\\'):
    data_set = []
...
# -------------------------------------------
learning_rate = 0.07  # just a constant value for a while, maybe add a "momentum" in the fьюча or would make a custom "changer" for it
